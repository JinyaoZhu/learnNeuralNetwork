...
X, y = make_blobs(n_samples=9, centers=3, n_features=2, cluster_std=0.5)
...
for classification in clf.classifications:
    ...
    for featureset in clf.classifications[classification]:
        plt.scatter(featureset[0],featureset[1], marker = "x", color=color, s=50, linewidths = 5, zorder = 10)

for c in centroids:
    plt.scatter(centroids[c][0],centroids[c][1], color='k', marker = "+", s=50, linewidths = 5)
